...
#include "transport.h"
#include "id.h"
#include "sys_pub_json.h" // this would be switched out for protobuf or other as needed

#define MODULE sys_pub_mqtt
LOG_MODULE_REGISTER(MODULE, CONFIG_SYS_PUB_MQTT_LOG_LEVEL);

#define MQTT_TOPIC_GET sys_pub_mqtt_topic_get
#define MQTT_PUBLISH sys_pub_mqtt_publish
// dt topic
#define TOPIC SYS_PUB_MQTT_TOPIC_DT_STR
#define TOPIC_DT_LEN ((sizeof(SYS_PUB_MQTT_TOPIC_DT_STR) + ID_LEN) + 1)
#define QOS_DT SYS_PUB_MQTT_DT_QOS

#define DT_OBJ_TYPE sys_info_t
