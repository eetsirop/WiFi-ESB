...
#include "transport.h"
#include "id.h"
#include "status_json.h" // this would be switched out for protobuf or other as needed

#define MODULE status_mqtt
LOG_MODULE_REGISTER(MODULE, CONFIG_STATUS_MQTT_LOG_LEVEL);

#define MQTT_TOPIC_GET status_mqtt_topic_get
#define MQTT_PUBLISH status_mqtt_publish
// dt topic
#define TOPIC STATUS_MQTT_TOPIC_DT_STR
#define TOPIC_DT_LEN ((sizeof(STATUS_MQTT_TOPIC_DT_STR) + ID_LEN) + 1)
#define QOS_DT STATUS_MQTT_DT_QOS

#define DT_OBJ_TYPE status_t
#define DT_OBJ_P_TYPE DT_OBJ_TYPE *

#define PAYLOAD_SIZE_MAX STATUS_PAYLOAD_STR_SIZE_MAX
