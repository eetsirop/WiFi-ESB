...
LOG_MODULE_REGISTER(heliogen_g5_node_nrf5340_cpuapp, CONFIG_LOG_DEFAULT_LEVEL);
...
static void remoteproc_mgr_config(void)
{
	...
	// Prevents BUS FAULT when CPUNET accesses CPUAPP shared RAM
	NRF_SPU->EXTDOMAIN[0].PERM |= BIT(1) | BIT(4);
