...
#include "transport.h"
#include "id.h"
#include "ncla_pub_json.h" // this would be switched out for protobuf or other as needed

#define MODULE ncla_pub_mqtt
LOG_MODULE_REGISTER(MODULE, CONFIG_NCLA_PUB_MQTT_LOG_LEVEL);

#define MQTT_TOPIC_GET ncla_pub_mqtt_topic_get
#define MQTT_PUBLISH ncla_pub_mqtt_publish
// dt topic
#define TOPIC NCLA_PUB_MQTT_TOPIC_DT_STR
#define TOPIC_DT_LEN ((sizeof(NCLA_PUB_MQTT_TOPIC_DT_STR) + ID_LEN) + 1)
#define QOS_DT NCLA_PUB_MQTT_DT_QOS

#define DT_OBJ_TYPE ncla_pub_t
#define DT_OBJ_P_TYPE DT_OBJ_TYPE *

#define PAYLOAD_SIZE_MAX NCLA_PUB_PAYLOAD_STR_SIZE_MAX
